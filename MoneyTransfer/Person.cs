...
namespace MoneyTransfer
{
    internal class Person
    {
        ...
        public void DisplayInfo()
        {
            ...
            Console.WriteLine($"Name:{name} Balance:{wallet.money}");
        }
        ...
        public bool TransferMoney(Person receiver, int amountToTransfer)
        {
            ...
            else if(wallet.money > amountToTransfer)
            {
                wallet.money = wallet.money - amountToTransfer;
                receiver.AcceptMoney(amountToTransfer);
                Console.WriteLine($"{amountToTransfer} was sent to {receiver.name} by {this.name}");
                return true;
            }
            return true;
        }
